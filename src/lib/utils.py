...
def get_full_outcomes():
    ...
    r4_l2=pd.read_csv(f"{DATA_DIR}/outcomes_l2.csv").rename(columns={"UID":"l2_UID"})
    r4_l3=pd.read_csv(f"{DATA_DIR}/outcomes_l3.csv").rename(columns={"UID":"l3_UID"})
    r4_l4=pd.read_csv(f"{DATA_DIR}/outcomes_l4.csv")
